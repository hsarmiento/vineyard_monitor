...
class Subsoil_moisture_001_model extends CI_Model {
    ...
    public function get_subsoil001_trending($pcb_id, $day)
    {
        $query = $this->db->query("SELECT t1.identifier as pcb_identifier, t1.id as pcb_id, 
                ...
                as t3 on t2.id = t3.sensor_id where t1.id = ".$pcb_id." and t2.type = 'SM001' and t3.created_at >= NOW() - INTERVAL ".$day." DAY 
